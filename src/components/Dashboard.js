    ...
    <div>
      ...
      <div className="dashboardelements">
        ...
        <div className="greycontainer">
          ...
          <div className="activity">{">"} Completed a quiz
          <span className="xp">25XP</span>
          </div>
          <div className="activity">{">"} Played a mini-game
          <span className="xp">15XP</span>
          </div>
          <div className="activity">{">"} Posted in the forums
        ...
        <div className="greycontainer">
          ...
          <div className="dashline"/>
          <div className="dailytask"> Completed a quiz
          <span className="xp">10XP</span>
          </div>
          <div className="dailytask"> Played a mini-game
          <span className="xp">10XP</span>
          </div>
          <div className="dailytask"> Browse the dictionary
          <span className="xp">10XP</span>
          </div>
          <div className="xpbar">
          <Progress_bar
      ...
      <div className="boxcontainer">
        ...
        <div className="boxcontainer">
        <div className="greycontainer">
          <div className="title">LEADERBOARDS
          </div>
          <span className="XPgained">
            {"("}XP gained during the last 7 days{")"}
          </span>
          <div className="dashline"/>
          <div className="leaderlist"> 1. Kyle
          <span className="xp">25XP</span>
          </div>
          <div className="leaderlist"> 2. Eric
          <span className="xp">15XP</span>
          </div>
          <div className="leaderlist"> 3. Stan
          <span className="xp">10XP</span>
          </div>
          <div className="leaderlist"> 3. Juu
          <span className="xp">10XP</span>
          </div>
        </div>
        </div>
